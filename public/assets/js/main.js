/*  ---------------------------------------------------
    ...
    Description:  Farmers Market eCommerce  HTML Template
    Author: Colorlib
...
(function($) {
  ...
  //Humberger Menu
  $(".humberger__open").on("click", () => {
    $(".humberger__menu__wrapper").addClass("show__humberger__menu__wrapper");
    $(".humberger__menu__overlay").addClass("active");
    $("body").addClass("over_hid");
  });

  $(".humberger__menu__overlay").on("click", () => {
  ...
  $(".product__details__pic__slider img").on("click", function() {
    ...
    const bigImg = $(".product__details__pic__item--large").attr("src");
    if (imgurl != bigImg) {
